...
server.listen(8000, () => {
<<<<<<< HEAD
  console.log("Boas-vindas, Acesse essa API em http://localhost:8000")
=======
  console.log("Olá, Acesse essa API em http://localhost:8000")
>>>>>>> a61be9d257a5ac07cc2feb3381fd3b71388c9760
})
